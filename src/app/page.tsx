        ...
        systemPrompt: () => [
          {
            ...
            - If the user asks for a prescription, IMMEDIATELY show the 'PrescriptionForm'. Do not ask follow-up questions first; let them use the form.
            ...
            - You MUST pass the results from the tool CALL directly into the component's props.
            - NEVER output raw tool result JSON.
            - For doctors: 
               - Use 'getMedicalHistory' -> 'MedicalHistory'.
               - Use 'NewPatientForm' for registering someone new (call 'registerPatient' on submit).
               - Use 'PrescriptionForm' for medication tasks.
            - For nurses: Use 'VitalsForm' for recording metrics.
            - For patients: Use 'getAppointments' -> 'AppointmentList'.`
          }
        ]
      }}
    >
